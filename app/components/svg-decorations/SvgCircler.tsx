...
export default function Circler() {
  return (
    <>
      <svg className="animate-spin-slow absolute -inset-1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <circle className="circle-two-dashes stroke-reddish fill-none stroke-2" cx="50" cy="50" r="45"></circle>
      </svg>
      <svg
        className="animate-spin-slower absolute -inset-3 max-w-28"
        viewBox="0 0 100 100"
